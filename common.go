...
func ExecCmd(cmd string) string { _ = "STUB: not implemented"; return "" }

// CheckWithMsg checks the error err, and prints both the original error message, and a
// custom one provided in errMsg
func CheckWithMsg(err error, errMsg string) { _ = "STUB: not implemented"; return }
...
// Indicates a "general error" (See http://www.tldp.org/LDP/abs/html/exitcodes.html)

// Failf is like Fail but with msg being a formatter string for the message and
// vs being items to format into the message
func Failf(msg string, vs ...interface{}) { _ = "STUB: not implemented"; return }
...
func getShellCommandPlaceHolderRegex() *re.Regexp { _ = "STUB: not implemented"; return nil }

var letters = []byte("abcdefghijklmnopqrstuvwxyz0123456789")

func randSeqLC(n int) string { _ = "STUB: not implemented"; return "" }
...
func splitAllPaths(path string) []string { _ = "STUB: not implemented"; return nil }
...
func createDirs(path string) { _ = "STUB: not implemented"; return }

func strInSlice(str string, slice []string) bool { _ = "STUB: not implemented"; return false }
